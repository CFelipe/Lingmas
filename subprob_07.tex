...
\section{Resoluções}
    \begin{enumerate}
        ...
        facilmente atribuir o valor de um subprograma à uma variável e então
        usar essa variável como argumento.

        \item
        Nós teremos passagem por valor, implementado por cópia, e passagem
        por referência.
        ...
        \begin{comment}
            Com sobrecarga:
                ...
                Final das contas, posso lembrar o nome de apenas uma função
                e fazer:
